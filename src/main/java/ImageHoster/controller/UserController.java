...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
    	...
    	if(!userService.verifyPasswordStrength(password)) {
    		password = "Password must contain atleast 1 alphabet, 1 number & 1 special character";
    		model.addAttribute("User", user);
    		model.addAttribute("passwordTypeError", password);
    		return "users/registration";
    	}
